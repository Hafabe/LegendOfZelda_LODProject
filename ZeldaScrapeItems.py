...
f = open('itemsNames.txt','a')

r = requests.get('http://zeldawiki.org/Category:Items')
...
r = requests.get('http://zeldawiki.org/index.php?title=Category:Items&pagefrom=Magic+Arrow#mw-pages')
