...
f = open('enemyNames.txt','a')

r = requests.get('http://zeldawiki.org/index.php?title=Category:Enemies&pageuntil=Hover#mw-pages')
				...
				if infoBox is not None:
					...
					for tableLinks in rows:
						...
						if MyTableLinks is not None:
							#if MyTableLinks 
							f2.write(('\n' + MyTableLinks['href'] + ',' + MyTableLinks.text + ',' + tableHeader.text + ',' + '\n').encode('utf-8'))
...
r = requests.get('http://zeldawiki.org/index.php?title=Category:Enemies&pagefrom=Hover#mw-pages')
...
r = requests.get('http://zeldawiki.org/index.php?title=Category:Enemies&pagefrom=Tinsuit#mw-pages')
